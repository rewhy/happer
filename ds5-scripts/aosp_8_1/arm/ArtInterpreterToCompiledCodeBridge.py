...
def ArtInterpreterToCompiledCodeBridge():
	...
	if config.debug:
		print "[ArtInterpreterToCompiledCodeBridge] ArtMethod::access_flags_ = %#x (%s)" % (art_method_access_flags_value, config.resolve_access_flags(art_method_access_flags_value))
	...
	config.log_print("[ArtInterpreterToCompiledCodeBridge] caller signature = %s" % caller_method_signature)
	config.log_print("[ArtInterpreterToCompiledCodeBridge] callee signature = %s" % callee_method_signature)
